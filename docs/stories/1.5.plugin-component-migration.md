...
## Tasks / Subtasks
- [ ] Task 1: Move CustomSearchPlugin (AC: 1)
  - [ ] Move `CustomSearchPlugin.tsx` to `webview-ui/src/components/plugins/CustomSearchPlugin.tsx`
  - [ ] Verify plugin implementation remains unchanged
- [ ] Task 2: Move SimplifiedAngleBracketPlugin (AC: 2)
  - [ ] Move `SimplifiedAngleBracketPlugin.tsx` to `webview-ui/src/components/plugins/SimplifiedAngleBracketPlugin.tsx`
  - [ ] Verify plugin implementation remains unchanged
- [ ] Task 3: Update import references in MDXEditorWrapper (AC: 3)
  - [ ] Update import for CustomSearchPlugin from `./CustomSearchPlugin` to `./plugins/CustomSearchPlugin`
  - [ ] Update import for SimplifiedAngleBracketPlugin from `./SimplifiedAngleBracketPlugin` to `./plugins/SimplifiedAngleBracketPlugin`
- [ ] Task 4: Verify plugin functionality (AC: 4, 5, 6)
  - [ ] Run TypeScript compilation check
  - [ ] Verify build process completes successfully
  - [ ] Test extension packaging with `npx vsce package`
  - [ ] Install and test CustomSearchPlugin functionality within MDX editor
  - [ ] Test SimplifiedAngleBracketPlugin functionality within MDX editor
  - [ ] Verify both plugins integrate correctly with MDXEditor component system
