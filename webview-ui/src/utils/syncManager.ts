...
export class SyncManager {
  ...
  sendContentToVSCode(content: string): void {
    ...
    if (
      this.state === SyncState.RECEIVING_FROM_VSCODE ||
    ...
    console.debug(`SyncManager: Using ${delay}ms delay (rapid typing: ${this.isRapidTyping.toString()})`);
   ...
   */
  private flushBatchedContent(): void {
